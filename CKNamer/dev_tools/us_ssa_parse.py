SOURCE = "us_ssa_source.txt" # Change to parse other file
OUTPUT = "us_ssa_output.txt" # Change to output other file
SPECIAL = "# Information gotten from https://www.ssa.gov/OACT/babynames/decades/names2010s.html\n"
...
for i in range(len(male_names)):
    output += male_names[i][0] + "::" + male_names[i][1] + "\n"

output += "\n>WOMEN\n\n"
print("Female names...")
for i in range(len(female_names)):
    output += female_names[i][0] + "::" + female_names[i][1] + "\n"
